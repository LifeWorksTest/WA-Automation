...
@AN14.1 @AN-Cinemas @Android @Smoke @Regression
Scenario Outline: Create a Cinema on Arch, upload tickets and complete purchase journey on the Android app
    ...
    Then I click "Perks" from the Android Menu Tab    
    Then I am on the Android Perks Home page
    Then I navigate to Android "Cinemas" screen from Android Perks Home page
