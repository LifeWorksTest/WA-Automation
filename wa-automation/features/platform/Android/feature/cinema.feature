...
Scenario Outline: Create a Cinema on Arch, upload tickets and complete purchase journey on the Android app
  	...
  	And I am on the Cinemas screen
	...
	And I click from the Menu screen "Cinemas"
	And I am on the Android Cinemas screen
	And I purchase "<amount_to_select_1>" "<ticket_type_1>" and "<amount_to_select_2>" "<ticket_type_2>" "<cinema_name>" tickets at "<cinema_location>" cinema branch
