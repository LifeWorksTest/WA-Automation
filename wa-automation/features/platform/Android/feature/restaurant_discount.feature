...
Scenario: Go over restaurant list and match restaurant details with the restaurant profile page
    ...
    And I click from the Menu screen "Restaurant Discount"
    When I am on the Android Restaurant Discounts screen
...
Scenario: Favorites and unfavorites restaurant from the restaurant page and check result in 'Favourites'
    ...
    And I click from the Menu screen "Restaurant Discount"
    When I am on the Android Restaurant Discounts screen
    Then I favorite the first restaurant in the list
    And I validate that the favorites counter as updated
    And I click from Android Restaurant Discounts screen "Favorites"
    Then I validate that the restaurant "is in" the favorites list
    And I unfavorite the restaurant from the favorites page
    And I validate that the favorites counter as updated
...
Scenario: Search for restaurant and go to restaurant page
    Given I am on the Android Menu screen
    And I click from the Menu screen "Restaurant Discount"
    And I am on the Android Restaurant Discounts screen
    And I click from Android Restaurant Discounts screen "Search"
    When I search for restaurant "aSa"
    Then I select "Masala" restaurant
    And I navigate back to more
    And I logout from the Android app

@AN7.5 @AN-RestureantDiscount @Android
