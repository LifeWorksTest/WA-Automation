...
AFFILIATE = {
  ...
  :email => 'lifeworkstesting+ca@lifeworks.com'
}
...
ACCOUNT = {
  :account_1 => {
    :user_email_to_make_as_admin => 'lifeworkstesting+ca1@lifeworks.com',
    ...
    :valid_account => {
      ...
      :company_nick_name => 'LifeWorksTesting CA',

      :company_name => 'LifeWorksTesting CA',
      :workangel_subdomain => 'lifeworkstesting-ca',
