HERMES_STRINGS = {
    ...
    "components" => {
        ...
        "main_menu" => {
            ...
            "colleague_offers" => "Colleague Offers",
    ...
    "offers" => {
        ...
        "title_2" => "Exclusive Colleague Offers",
    ...
    "premium_banner" => {
        ...
        "learn_more" => {
            ...
            "got_it" => "Got it",
            "more_info" => "For more information about LifeWorks %{package} please check out our",
    ...
    "counsellor_locator" => {
        ...
        "block_2" => {
            "title" => "Contact us by phone at %{phone}",
        ...
        "block_3" => {
            ...
            "description_list" => {
                "item_1" => "Search for your locations.",
                "item_2" => "Find your nearest counselor.",
                "item_3" => "Contact us via phone to arrange your session with your desired counselor."
            }
        },
        "block_4" => {
    ...
    "cinemas" => {
        ...
        "banner_subtitle" => "Save up to 40% at 300 cinemas nationwide",
        "walkthrough" => {
        ...
        "form" => {
            ...
            "question" => {
                "copy" => {
                    ...
                    "line_5" => "Type of childcare required: child care centres, family day care or both",
    ...
    "limited_account" => {
        ...
        "chat_feature" => {
            ...
            "subtitle" => "Chat directly with a counselor, 24 hours a day, 7 days a week, 365 days a year."
        },
        "cerner_feature" => {
            "title" => "Wellness tools",
