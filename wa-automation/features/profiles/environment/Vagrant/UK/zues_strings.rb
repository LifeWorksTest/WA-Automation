ZEUS_STRINGS = {
    ...
    "new_post" => {
        ...
        "post_btn" => "Post",
        "cancel_btn" => "Cancel",
        "title" => "Create a new company post",
    ...
    "cropping_tool" => {
        ...
        "step_2" => {
            ...
            "subtitle" => "Select which part of the image you would like to be used"
        },
        "cancel" => "Cancel",
        "save" => "Save"
    },
    ...
    "login" => {
        ...
        "reset_request" => {
            ...
            "not_recognised" => "Your email address is not recognised.<br>Please try again.",
            "email" => "Email Address",
    ...
    "account" => {
        ...
        "billing_info" => {
            ...
            "next_payment" => "Your next payment will be taken on the",
            "premium_acc" => "You have been on a %{package} account since the",
            "you_are_paying" => "You are paying",
            "per_month" => "per employee \/ per month.",
            "protected" => "Your payment is protected by the",
            "direct_debit" => " Direct Debit Guarantee"
        },
        "revoke_admin" => {
        ...
        "pricing" => {
            ...
            "feature_list" => " view full feature list"
        },
        "continue" => {
            "title" => "Continue on %{package}",
            "subtitle" => "Continue on our %{package} plan to keep enjoying the benefits of LifeWorks once your trial has ended."
        },
        "your_plan" => {
            "title" => "Free Trial",
            "trial_ends" => "Your current trial ends on the",
            "upgrade" => "Upgrade your account now to continue enjoying LifeWorks %{package}.",
            "for_only" => "For only",
            "per_month" => "per employee \/ per month. Your first payment will be taken on the %{nextPaymentDate}.",
            "get_premium" => "Get LifeWorks %{package}",
            "downgraded" => "If you do not upgrade to %{package} then you will be downgraded to our %{packageDown} plan once your trial has ended.",
            "more_info" => "For more information",
            "feature_list" => "view feature list"
        },
        "tile_lite" => {
            "per_month" => "Per employee \/ month"
        },
        "tile_premium" => {
            "per_month" => "Per employee \/ month",
            "get_premium" => "Get LifeWorks %{package}"
        ...
        "deactivate_one" => {
            "panel_title" => "Are you sure you want to deactivate<br>%{nickname}?",
            "employees_earned" => "Your employees<br>have earned",
            "cashback" => "cashback",
            "employees_spent" => "Your employees<br>have spent",
            "total" => "in total",
            "total_of" => "You have a<br>total of",
            "active_users" => "active users",
            "employees_sent" => "Your employees<br>have sent",
            "recognitions" => "recognitions",
            "once_deactivated" => "Once your account is deactivated",
            "text" => "Your employees will not be able to withdraw their cash without contacting LifeWorks<br>Your employees will not be able to use shopping and dining benefits<br>Your company\u2019s network will be suspended",
            "are_you_sure" => "Are you sure you want to deactivate your account?",
            "cancel_btn" => "Cancel",
            "continue_btn" => "Continue"
        },
        "deactivate_two" => {
            "title" => "You have decided to deactivate the %{nickname} account.",
            "subtitle" => "Before you go, we\u2019d love to know why you have decided to deactivate the %{nickname} account.",
            "small_text" => "You can select multiple reasons and all information is confidential.",
            "select_reason" => "Please select at least 1 reason or type a short response if you have selected \"I have other reasons\".",
            "cancel_btn" => "Cancel",
            "deactivate_btn" => "Deactivate",
            "placeholder" => "Type something. Minimum 10 characters...",
            "reason_1" => "LifeWorks is too expensive",
            "reason_2" => "LifeWorks is not effective",
            "reason_3" => "LifeWorks\u2019s feature(s) don\u2019t work for our company",
            "reason_4" => "LifeWorks is missing a feature\/features",
            "reason_5" => "I have other reasons",
            "deactivated" => "Your company has been deactivated",
            "error" => "There was a problem deactivating your company. Please contact LifeWorks support."
        },
        "transfer_ownership" => {
        ...
        "optin" => {
            "upgrade" => "Upgrade to the %{package} plan",
            "retain" => "<span class='body-3'>Retain <\/span>and<span class='body-3'> engage <\/span>your employees better than before. Upgrade to the %{package} Plan and help them save<span class='body-3'> %{currency}1000\u2019s <\/span>a year through exclusive savings & discounts!",
            "premium" => "Upgrade to %{package}"
        },
        "payment_details" => {
            "banner_title" => "View your details",
            "info" => "Here is the billing information that you provided us with when you joined our %{package} plan.",
            "tc" => "LifeWorks T&C's",
            "toaster_opted_in" => "You're opted-in to %{package}. Your first payment will be taken on %{date}."
        },
        "payment_method" => {
        ...
        "change_card" => {
            "title" => "Change card?",
            "replace_card" => "Your current card will be replaced with a new card if you continue.",
        ...
        "payments" => {
            ...
            "invoice_sent" => "An email containing the invoice from %{date} has been sent.",
            "invoices_sent" => "An email containing all your invoices has been sent.",
            "popover" => "Your payment has failed. We will try to charge your card again in a couple days."
        },
        "pricing_sum" => {
            "title" => "Pricing Summary",
            "workangel_premium" => "You are using LifeWorks %{package}",
            "calculate" => "How we calculate your monthly costs",
        ...
        "after_expire" => {
            "more_info" => "For more information view",
            "list" => "full feature list"
        },
        "upgrade" => {
        ...
        "after_optin" => {
            ...
            "subtitle" => "See the detailed breakdown of your monthly charges in your pricing summary.",
            "tc" => "LifeWorks T&C's"
        },
        "card_edit" => {
            "panel_title" => "Card Details",
            "change_card" => "Change Card",
            "card_expired" => "Your payment card has now expired. Please add new payment card to avoid disruption to your network.",
            "name_on_card" => "Name on card",
            "brand" => "Brand",
            "card_number" => "Card Number",
            "last_four_digits" => "xxxx-xxxx-xxxx-%{lastFourDigits}",
            "expired" => "Expired",
            "expiry_date" => "Expiration Date",
            "billing_address" => "Billing Address",
            "address_1" => "Address 1",
            "required_address" => "Address Line 1 is required.",
            "address_2" => "Address 2",
            "town" => "Town\/City",
            "required_city" => "City is required.",
            "postcode" => "Postcode",
            "required_post" => "Post Code is required.",
            "country" => "Country",
            "required_country" => "Country is required.",
            "save_btn" => "Save",
            "cancel_btn" => "Cancel",
            "saved" => "Your changes have been saved.",
            "not_saved" => "We could not validate your card.",
            "error" => "There was an error processing your request. Please try again."
        },
        "card_details" => {
            "card_has_expired" => "Your payment card has now expired. Please add new payment card to avoid disruption to your network.",
            "name_on_card" => "Name on card",
            "brand" => "Brand",
            "card_number" => "Card Number",
            "expired" => "Expired",
        ...
        "card_new" => {
            "panel_title" => "Card Details",
            "name_on_card" => "Name on card *",
            "as_on_card" => "Exactly as it appears on your card.",
            "enter_name" => "Please enter a name between 3 and 20 characters",
            "card_number" => "Card Number *",
            "card_digits" => "16 digit card number on the front.",
            "valid_number" => "Please enter a valid card number",
            "expiry_date" => "Expiration Date *",
            "date_filter" => "MM \/ YYYY",
            "valid_date" => "Please enter a valid expiration date",
            "security_code" => "Security Code *",
            "what_is_it" => "What is it?",
            "valid_sec_code" => "Please enter a valid security code",
            "billing_address" => "Billing Address",
            "same_as_address" => "Same as main address",
            "address_1" => "Address Line 1 *",
            ...
            "postcode" => "Postcode *",
            "enter_post" => "Please enter a postcode",
            "country" => "Country *",
            ...
            "popover" => "The 3 digit number located on the back of your card. If you are using American Express, it's the front 4 digits on the top right."
        },
        "pricing_pro" => {
            "panel_title" => "Pricing",
            "pro_plan" => "Your LifeWorks Pro Plan is &lt;strong&gt;Perks &amp; Recognitions&lt;\/strong&gt;.",
            "small_text" => "How we calculate your monthly costs",
            "price_per_month" => "Price per user<br>per month",
            "total_active" => "Total active users",
            "total_month_cost" => "Total monthly<br>cost",
            "additional_info" => "Additional Information",
            "start_date" => "Account start date",
            "next_billing_date" => "Next billing date",
            "history" => "View all historic payments",
            "vat" => "VAT"
        }
    },
    "add_admin" => {
    ...
    "badge_lib" => {
        ...
        "library" => {
            ...
            "label_1" => "When your employees send recognition they must choose a badge to give additional context to why they are recognising their colleagues. The badges available to them can be managed here.",
    ...
    "widget" => {
        ...
        "optin" => {
            "title" => "Upgrade to LifeWorks %{package}",
            "retain" => "<span class='body-3'>Retain <\/span>and<span class='body-3'> engage <\/span>your employees better than before. Upgrade to the %{package} Plan and help them save<span class='body-3'> %{currency}1000\u2019s <\/span>a year through exclusive savings & discounts!",
            "get_premium" => "Get LifeWorks %{package}"
        }
    },
    ...
    "employee" => {
        ...
        "directory" => {
            ...
            "upgrade_tooltip" => "<u>Upgrade<\/u> to access the feature - <br>Manage your employees in the<br>company efficiently"
        }
    },
    "post_login" => {
    ...
    "leaderboard" => {
        ...
        "performance" => {
            ...
            "invite" => "Invite colleagues to %{vmCompanyName} and encourage them to recognise one another!",
    ...
    "network_reactivation" => {
        "modal_card" => {
            "replace_card" => "Your current card will be replaced with a new card.<br>Do you want to continue?",
            "cancel_btn" => "Cancel",
            "change_card_btn" => "Change card"
        },
        "contact" => {
            "account_deactivated" => "Your account is deactivated.",
            "contact_workangel" => "Please contact LifeWorks to reactivate your account.",
            "email_btn" => "Email",
            "logout_btn" => "Logout"
        },
        "message" => {
            "title" => "Your account is deactivated.",
            "label_1" => "You have deactivated %{company} account on",
            "label_2" => "To reactivate your account please update your billing details.",
            "label_3" => "%{company} account has been deactivated on",
            "label_4" => "because of the following missed payments.",
            "unpaid" => "Unpaid",
            "label_5" => "To activate your account please update your billing details. Once your details are up to date, we will process the due ammount and reactivate your account.",
            "update_billing_details" => "Update Billing Details",
            "logout" => "Logout"
        },
        "details" => {
            "title" => "Network Reactivation",
            "update_billing_details" => "The following payment card is associated with your account.<br>Please update your billing details to continue.",
            ...
            "brand" => "Brand",
            "number" => "Card Number",
            "label_1" => "xxxx-xxxx-xxxx-%{lastFourDigits}",
            "expired" => "Expired",
            "expiry_date" => "Expiration Date",
            "billing_address" => "Billing Address",
            "address_1" => "Address Line 1",
        ...
        "edit" => {
            "title" => "Network Reactivation",
            "review_details" => "Please review your billing details.<br>Once done tick the \u2018information is up to date\u2019 box and click Reactivate Account.",
            "card_details" => "Card Details",
            "change_card_btn" => "Change card",
            "card_expired" => "Your payment card has now expired. Please add new payment card to avoid disruption to your network.",
            "name" => "Name on card",
            ...
            "country" => "Country",
            "required_country" => "Country is required.",
            "confirm_info" => "I confirm the information is up to date.",
            "tick_box" => "Please tick the box to continue.",
            "update_btn" => "Update",
            "not_activated" => "We could not validate your card.",
            "account_reactivated" => "Your account has been reactivated.",
            "error" => "We could not activate your account at this time. Please contact LifeWorks Support."
        },
        "new" => {
            "title" => "Network Reactivation",
            "fill_in_fields" => "Fill in all required fields.<br>Once complete click Reactivate Account.",
            "card_details" => "Card Details",
            "name_on_card" => "Name on card *",
            "as_on_card" => "Exactly as it appears on your card.",
            "number" => "Card Number *",
            ...
            "country" => "Country",
            "select_country" => "--- Please select a country ---",
            "reactivate_btn" => "Reactivate account",
            "not_activated" => "We could not validate your card.",
            "account_reactivated" => "Your account has been reactivated.",
            "error" => "There was an error processing your request. Please try again.",
            "error_2" => "We could not activate your account at this time. Please contact LifeWorks Support.",
            "popover" => "The 3 digit number located on the back of your card. If you are using American Express, it's the front 4 digits on the top right."
        }
    },
    "opt_in" => {
        "direct_debit" => {
            ...
            "label_1" => "This Guarantee is offered by all banks and building societies that accept instructions to pay Direct Debits",
            "label_2" => "If there are any changes to the amount, date or frequency of your Direct Debit GoCardless Ltd re: LifeWorks will notify you 3 working days in advance of your account being debited or as otherwise agreed. If you request GoCardless Ltd re: LifeWorks to collect a payment, confirmation of the amount and date will be given to you at the time of the request",
            "label_3" => "If an error is made in the payment of your Direct Debit, by GoCardless Ltd re: LifeWorks or your bank or building society, you are entitled to a full and immediate refund of the amount paid from your bank or building society",
            "label_4" => "If you receive a refund you are not entitled to, you must pay it back when GoCardless Ltd re: LifeWorks asks you to",
            "label_5" => "You can cancel a Direct Debit at any time by simply contacting your bank or building society. Written confirmation may be required. Please also notify us."
        },
        "banner" => {
            "secure_payment" => "Secure Payment",
            "step" => "Step",
            "banner_1" => "Enter your Bank details",
            "banner_2" => "Check your details",
            "banner_3" => "Direct Debit Successful"
        },
        "action_block" => {
            "cancel_btn" => "Cancel",
            "back_btn" => "Back"
        ...
        "footer" => {
            "email" => "support@lifeworks.com",
            "tel" => "+44 (0)203 567 5900",
            "address" => "LifeWorks Ltd, 1 Battersea Bridge Road, The Glassmill, 4th floor, London, SW11 3BZ"
        },
        "form" => {
            "per_employee" => "per employee \/ per month. Payment for LifeWorks Technology."
        },
        "step_1" => {
            "title" => "Account holder name",
            "error" => "This field is required",
            "tooltip" => "The name that appears on your bank statement",
            "placeholder" => "Full name",
            "account_number" => "Bank account number",
            "valid_account" => "Enter a valid bank account number",
            "label_1" => "The 6-8 digit number found on your credit\/debit card or bank statement",
            "sort_code" => "Bank sort-code",
            "valid_sort_code" => "Enter a valid bank sort code",
            "label_2" => "The 6 digit number found on your credit\/debit card or bank statement",
            "error_2" => "It seems something went wrong. Please re-enter your information and continue.",
            "check_box" => "I am the account holder and the only person required to authorise debits on this account.",
            "field_required" => "This field is required",
            "confirming" => "By confirming you are pre-authorising payments to LifeWorks and agree to our ",
            "tc" => "Terms & Conditions",
            "payment_protected" => " Your payments are protected by the ",
            "direct_debit" => "Direct Debit Guarantee"
        },
        "step_2" => {
            "title" => "Account holder name:",
            "account_number" => "Bank account number:",
            "sort_code" => "Sort-code:",
            "error" => "It seems something went wrong. Please return to the previous screen and check your information to continue.",
            "confirm_btn" => "Confirm"
        },
        "step_3" => {
            "dd_success" => "Your Direct Debit has been successfully set up. You will receive confirmation via email within three working days. You can view a copy of your Direct Debit guarantee ",
            "here" => "here",
            "print" => " Please print and retain for your records. LifeWorks will appear on your bank statement.",
            "missed_payment" => "It seems that you missed a payment of",
            "upgrade_account" => "Before we can upgrade your account to %{package}, we will be charging you for this amount. This can take up-to 3 working days. Your account will automatically be upgraded to %{package} after this payment has been confirmed.",
            "done_btn" => "Done"
        }
    },
    "deactivated" => {
        "thank" => "Thank you for using LifeWorks",
        "missing" => "LifeWorks is missing you already!<br> Hope to see you soon",
        "error" => "Something went horribly wrong?<br>Click the button below to reactivate your account",
        "react_btn" => "Reactivate my account"
    },
    "rewards" => {
        "confirm_body" => {
            "his" => "his",
    ...
    "settings" => {
        ...
        "invitation" => {
            ...
            "automatic_signup" => "Allow automatic sign ups without my authorisation",
            "copy_btn" => "Copy Url",
        ...
        "plan_edit" => {
            ...
            "manage_feature" => "Manage which feature %{company} colleagues can access to create a more personalised experience",
        ...
        "plan" => {
            "panel_title" => "Manage which feature %{company} colleagues can access to create a more personalised experience",
            "social_rec" => "Social Recognition",
            "allow_to_send" => "Allow colleagues to send Recognition to one another when they do great things.",
            "company_feed" => "Company Feed",
    ...
    "plan_constants" => {
        ...
        "analytics" => " analytics",
        "dedicated" => "Dedicated",
        "management" => " account management & support",
        "label_1" => "Limited social features",
        "label_2" => "Limited discounts",
        "label_3" => "Limited admin reporting",
        "label_4" => "Limited analytics",
        "label_5" => "Limited account management"
    },
    "lite_constants" => {
        "benefits_categories" => "View the most popular shopping categories in your company.",
        "benefits_brands" => "View the most popular shopping brands in your company.",
        "benefits_spendings" => "View your company total spending on discounts.",
        "leaderboard_performance" => "Want to see how your employees are performing?",
        "leaderboard_engagement" => "Want to see how your employees are engaging with each other?",
        "leaderboard_achievements" => "Encourage your employees to give recognition based on your company culture.",
        "new_post" => "Communicate with your company through the newsfeed."
    },
    "hide_premium" => {
        "upgrade_feature" => "Upgrade",
        "to_use_feature" => "to use this feature.",
        "upgrade_unlock" => "Upgrade to unlock the full list.",
        "upgrade" => "Upgrade to %{package}"
    },
    "jumbotron" => {
        "title" => "Stay on %{package}",
        "trial_ends" => " Your current trial ends on the <span class='body-3'> %{date}.<\/span> Upgrade your account now to continue enjoying LifeWorks %{package}.",
        "continue_btn" => "Continue on %{package}"
    },
    "premium_badge" => {
        "trial" => "This %{package} feature is available to you during your trial period.",
        "lite" => "Custom values are only avalaible on %{package}."
    },
    "premium_banner" => {
        "achievements" => "Want to empower employees with more custom recognition badges? These will only be available on %{package}.",
        "engagement" => "Want to see how all of your employees are engaging with each other? This feature will only be available on %{package}.",
        "performance" => "Want to see how all of your employees are performing? This feature will only be available on %{package}."
    },
    "package_change_popup" => {
        "premium" => {
            "title" => "Your company has upgraded to LifeWorks %{package}!",
            "subtitle" => "Congratulations, your company has upgraded to LifeWorks %{package}! Here's a snapshot of some the perks you get with LifeWorks %{package}:",
            "item_1" => "Enhanced Social Features",
            "item_2" => "Boosted and Exclusive Discounts & Cashbacks",
            "item_3" => "Unlimited Retailers and Restaurants discounts"
        },
        "lite" => {
            "title" => "Your Company's LifeWorks %{package} has expired.",
            "subtitle" => "Don't worry, it still works. However, until your company upgrades, you will receive LifeWorks %{package} only",
            "item_1" => "Basic Social Features",
            "item_2" => "Lower Discounts & Cashbacks",
            "item_3" => "Limited Restaurants discounts",
            "item_4" => "Wallet withdrawal fees",
            "footer" => "Upgrade to %{package} now by going to your Account Settings."
        },
        "got_it" => "Got it",
        "more_info" => "To learn more about our features visit ",
