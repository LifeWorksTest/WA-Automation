HERMES_STRINGS = {
    ...
    "links" => {
        "help" => "https:\/\/help.lifeworks.com\/hc\/en-gb",
        "help_sso" => "https:\/\/lifeworks1470751750.zendesk.com\/access\/jwt?jwt=%{zendeskToken}",
        "contact" => "https:\/\/help.lifeworks.com\/hc\/en-gb\/requests\/new",
        "privacy_policy" => "https:\/\/help.lifeworks.com\/hc\/en-gb\/articles\/209973963-Privacy-And-Cookies-Policy",
        "terms_and_conditions" => "https:\/\/help.lifeworks.com\/hc\/en-gb\/articles\/208462076-User-Terms-And-Conditions",
        "end_user_license" => "https:\/\/help.lifeworks.com\/hc\/en-gb\/articles\/209973913-End-User-Licence-Agreement",
    ...
    "components" => {
        ...
        "interests_cta" => {
            ...
            "label_2" => "Tell us what you're interested in and get personalised recommendations.",
        ...
        "main_menu" => {
            ...
            "counsellor_locator" => "Counsellor Search",
    ...
    "globals" => {
        "cookie_law" => {
            "message" => {
                "desktop" => "We use cookies and other technology that recognise you to improve your online experience. By using this site you consent to this use in our",
                "tablet" => "We use cookies and other technology that recognise you to improve your online experience."
            },
            "link_tag" => {
    ...
    "forgotten_password" => {
        ...
        "registered_email" => "Please enter your registered email address",
        "email" => "Email Address",
        "action" => "SUBMIT",
    ...
    "offers" => {
        ...
        "code" => "Code",
        "bar_code" => "Bar Code",
        "subtitle_1" => "Great savings at the best high street stores",
    ...
    "feed" => {
        ...
        "post" => {
            ...
            "ago_today" => " ago today, %{user} joined ",
    ...
    "local_deals" => {
        ...
        "no_favorite_deals" => "You currently don't have any favourited deals.",
        ...
        "ldp_directive" => {
            "add" => "The deal has been added to your favourites",
            "remove" => "The deal has been removed from your favourites"
        }
    },
    "page_not_found" => {
    ...
    "profile" => {
        "achievements" => {
            ...
            "be_recognised" => "Be recognised %{count} times by your colleagues to reach this milestone!",
            "newbie" => {
                "name" => "Newbie"
            },
            "hotshot" => {
        ...
        "recognition_comp" => {
            ...
            "recognise" => "<span translate>Recognise<\/span> your colleague for their great work!",
            "do_great" => "Do something great in your team, and be<span translate translate-comment='Adjective'> recognised<\/span>!",
    ...
    "profile_edit" => {
        ...
        "mobile_error" => "This is not a mobile phone number",
    ...
    "restaurant_detail" => {
        ...
        "terms_con" => {
            ...
            "label_11" => "To cancel a booking, follow the link in the confirmation email or contact the restaurant directly. Cancelled booking will not be eligible for cashback.",
    ...
    "settings" => {
        ...
        "package" => {
            "title" => "Package",
            "current_package" => "Your company is currently using",
    ...
    "wallet" => {
        "transactions" => {
            ...
            "empty_shop" => {
                ...
                "info" => "Reward yourself and save money at the same time. With over 1,000 retailers to choose from, get the latest special offers from your favourite brands."
            },
        ...
        "modal" => {
            "hint" => {
                ...
                "subtitle_slide1" => "Your wallet is where all your Cashback from online shopping and dining is available to view and withdraw.",
                "title_slide2" => "How do I withdraw my Cashback?",
                "subtitle_slide2_1" => "You can withdraw your Cashback from your wallet to your bank account or PayPal account.",
                "subtitle_slide2_2" => "You can withdraw your Cashback from your wallet to your bank account.",
    ...
    "online_shop" => {
        "boosted" => {
            ...
            "modal_copy_3" => "Cashback will not be paid in conjunction with any other offer, voucher or discount code unless listed on this page, or with any other discounts such as staff or student discount. Cashback may not be paid on VAT, delivery, card payment fees, taxes or any other additional charges."
        },
        "categories" => {
            "title" => "Home"
        },
    ...
    "online_shop_search" => {
        "retailer_add" => "The retailer offer has been added to your favourites",
        "retailer_remove" => "The retailer offer has been removed from your favourites",
        "special_add" => "The special offer has been added to your favourites",
        "special_remove" => "The special offer has been removed from your favourites"
    },
    "directory" => {
    ...
    "leaderboard" => {
        ...
        "label_1" => "Nobody has been recognised yet",
        "label_2" => "Give Recognition",
        "lite_tile" => "See your full company Leaderboard with LifeWorks %{package} only.",
        "more_btn" => "Learn More"
    },
    "notifications" => {
        "comp" => {
    ...
    "rewards_catalog" => {
        ...
        "modal_comp" => {
            "error_ms" => "OOPS. WE CAN'T RECOGNISE THIS POSTCODE. TRY AGAIN.",
    ...
    "sign_up" => {
        ...
        "features_comp" => {
            ...
            "description_2" => "Recognise your colleagues for their hard work & achievements.",
        ...
        "fieldset_right" => {
            ...
            "mobile_placeholder" => "e.g. 0700 000 0000",
            "label_4" => "Please enter a valid mobile number",
    ...
    "premium_banner" => {
        "more" => "Learn more",
        "learn_more" => {
            "upgrade_admin" => "Upgrade to %{package} now by going into your Admin Panel.",
            "upgrade" => "To upgrade to LifeWorks %{package}, contact your network administrator.",
            "subtitle" => "LifeWorks %{package} gives you all this great stuff:",
            "item_1" => "Unbeatable discounts on Shopping and Restaurants",
            "item_2" => "A personal digital Dining Card (%{currency} 80 RRP)",
            "item_3" => "Fast cashback payment times",
            "item_4" => "No fees to withdraw cashback",
            "item_5" => "Full Recognition Leaderboard",
            "item_6" => "Unlimited Recognition Badges",
            "got_it" => "Got it",
            "more_info" => "To learn more about our features visit",
            "our_website" => "our website"
        },
        "title_default" => "More Features available with LifeWorks %{package} only.",
        "title_social" => "More Social Features available with LifeWorks %{package} only.",
        "title_leaderboard" => "Access your full company leaderboard available with LifeWorks %{package} only.",
        "title_restaurant" => "1000's more 50% Restaurant perks available with LifeWorks %{package} only.",
        "title_discount" => "Exclusive perks and faster cashback available with LifeWorks %{package} only.",
        "title_giftcard" => "Market leading perks and more Gift Cards available with LifeWorks %{package} only.",
        "title_wallet" => "No wallet withdrawal fees and faster cashback with LifeWorks %{package} only."
    },
    "walk_through" => {
        "introduction" => {
        ...
        "giverecog" => {
            ...
            "subtitle" => "Recognise your colleagues for their hard work & achievements."
        },
        "company" => {
    ...
    "medicare_interactive" => {
        ...
        "title" => "What is in the medical interactive",
        ...
        "list" => {
            ...
            "item_5" => "MI Counsellor, an online \u201cencyclopedia of Medicare\u201d to search within broad topics or look up specific terms"
        }
    },
    "counsellor_locator" => {
        "hero" => {
        ...
        "block_1" => {
            ...
            "description_2" => "A LifeWorks Advisor will help you determine which option is right for you based on your individual situation, schedule, and comfort level with technology. Consultants will work with you to understand the most pressing issue you are facing and help you establish which type of support might best suit your needs. Referrals are available to counsellors and coaches by phone, live by video, and in person."
        },
        "block_2" => {
            "title" => "Contact us by phone",
            "description_1" => "You can request an appointment to meet with a local EAP counsellor for in-person sessions by calling %{phone}.\u200b\u200b\u200b\u200b\u200b",
            "description_2" => "When you call LifeWorks, a consultant will work with you to help you find a counsellor who is the best fit given your circumstances  LifeWorks is committed to matching you with the best available counsellor who can meet your needs.",
            "description_3" => "Please note that you must call must call %{phone} to obtain the authorization needed for services before scheduling the first appointment.",
            "description_4" => "You may use this tool to search for local counsellors before you speak with one of the LifeWorks consultants to schedule in-person sessions."
        },
        "block_3" => {
            "title" => "How to book a counsellor",
            "description_list" => {
                "item_1" => "Enter in the address in the area you are looking for a counsellor (NOTE: please enter more than just the zip code).",
                "item_2" => "Select up to three providers and note their names and locations.",
                "item_3" => "Call LifeWorks at %{phone}. A consultant will conduct an assessment in order to authorize your EAP sessions. You can request a referral to one of the counsellors you have selected.  Depending on the urgency or nature of your issue we may need to recommend counsellors other than those you select."
            }
        },
        "block_4" => {
        ...
        "counsellors_found" => "Counsellors found",
        "illegal_char" => "No results found as search contains invalid characters",
        "open_in_maps" => "Open in Google Maps",
        "breadcrumbs" => {
            "home" => "Home",
            "search_results" => "Counsellor search results"
        }
    },
    "chat" => {
        "hero" => {
    ...
    "wellness_categories" => {
        ...
        "cat_title" => "Choose some topics to personalise your daily wellbeing content",
    ...
    "wellness_tools" => {
        ...
        "block_4" => {
            ...
            "description" => "In addition to the programmes listed above, for which full online tools are available, our health coaches can help you with other health goals, whether it\u2019s finding an exercise routine you can maintain, adopting a healthier range of food in your diet, or getting past barriers in making lifestyle changes. "
        },
    ...
    "giftcards" => {
        ...
        "title_2" => "With up to 12% discount on deals",
        "total" => "Total",
        "vat_inc" => "including VAT",
        "your_order" => "Your Details",
        "your_order_number" => "Your Order number is ",
    ...
    "restaurants" => {
        ...
        "errors" => {
            ...
            "no_favourites" => {
                "title" => "Add a favourite restaurant!",
    ...
    "need_help" => {
        ...
        "form_1" => {
            ...
            "subtitle" => "This form should be used for general questions about the programme.",
            "ctaCopy" => "View form"
        },
        "form_2" => {
            "title" => "Childcare",
    ...
    "child_care" => {
        ...
        "form" => {
            ...
            "question" => {
                "copy" => {
                    "head" => "Please provide the following information in order for us to complete a childcare search:",
                    ...
                    "line_5" => "Type of childcare required: childcare centres, family day care or both",
                ...
                "label" => "We will identify providers who best match your needs and email you profiles of childcare providers. You will receive a response 3-5 business days after submitting your form.",
    ...
    "general_enquiry" => {
        ...
        "top_title" => "What is your enquiry regarding?",
        ...
        "options" => {
            ...
            "couselling" => {
                ...
                "disclaimer" => "To enquire about or set-up counselling services, please call "
            },
            "other" => {
                "name" => "Other",
    ...
    "limited_account" => {
        "feed_post" => {
            ...
            "content" => "3 minutes a day of personalised content, delivered in your news feed from world class experts, exclusive to you.",
