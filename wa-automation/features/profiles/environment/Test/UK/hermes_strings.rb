HERMES_STRINGS = {
    ...
    "limited_account" => {
        ...
        "chat_feature" => {
            "title" => "Chat to us online to get support",
            "subtitle" => "This is available at certain times throughout the day depending on volume of clients using this feature."
        },
        "cerner_feature" => {
    ...
    "feed" => {
        ...
        "wellness_post" => {
            "reflection" => {
                ...
                "focus_another_interest" => "Focus on another of your wellness interests",
    ...
    "wellness_tools" => {
        ...
        "error_link" => "Oops, something went wrong",
        "disclaimer" => "Clicking on the link above will open the Web site in a new browser window (this means that you are leaving the LifeWorks site). Linking to external Web sites does not imply an endorsement by LifeWorks of any product, resource, or service provided by those Web sites."
    },
    "constants" => {
        "categories" => {
            "featured" => "Featured",
    ...
    "walk_through" => {
        ...
        "company" => {
            "title" => "News Feed",
            "subtitle" => "Keep up to date with what's going on."
        },
        "cta" => "Get Started"
    },
